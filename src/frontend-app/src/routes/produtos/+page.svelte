<script lang="ts">
    ...
    import ProdutoTable from '../../components/ProdutosTable.svelte';
  ...
  {:else if canView}
    <div class="text-center p-8 pt-32">
      <div class="flex items-center justify-between max-w-3xl mx-auto mb-6">
        <Heading tag="h2" class="block w-full text-center text-5xl font-instrument font-light tracking-tight text-white">PRODUTOS</Heading>

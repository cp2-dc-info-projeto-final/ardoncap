...
<div class="w-full max-w-3xl px-4 md:px-8">
  <div class="text-center p-8 pt-32">
    ...
    <P class="text-lg leading-relaxed text-white dark:text-gray-300 mb-4 text-justify">
    ...
    <P class="text-base leading-relaxed text-white dark:text-gray-400 text-justify">
      Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem.
    </P>
    <ImagePlaceholder class="my-8 mx-auto" />
    <P class="text-base leading-relaxed text-white dark:text-gray-300 mb-4 text-justify">
